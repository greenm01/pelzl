...
Pelzl is a Curses-based RPN calculator.

== Installation
=== Using OPAM
The recommended method for installing Pelzl is to use
https://opam.ocaml.org/[OPAM].  +opam install pelzl+ should get the job done.
